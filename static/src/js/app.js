// Lazy loading jQuery example :
// condition / event / whatever () => {
    ...
    import('jquery').then((jquery) => {
        ...
        import('popper.js').then(() => {
            import('bootstrap').then(() => {
                ...
                // Ne pas s'occuper de cette partie, réservée à la page d'éléments bootstrap
                if (document.getElementById('bootstrap_debug_page')) {
